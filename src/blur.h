...
private:
    ...
    Region m_paintedDeviceArea; // keeps track of all painted areas in device coordinates (bottom to top)
    Region m_currentDeviceBlur; // keeps track of the currently blurred areas in device coordinates (bottom to top)
